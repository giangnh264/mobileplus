...
function logPlayCollection()
{
    /*log play collection*/
    var id = $("#collection_id").val();
    var before_log = false;
    var success_log = function(html){
        if(html!="true"){
            activity_logged = true;
        }
    }
    var log_url = base_url+'player/logCollection/'+id;
    ajax_load(log_url,{}, before_log,success_log);
}