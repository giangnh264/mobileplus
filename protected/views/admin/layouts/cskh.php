...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="<?php echo Yii::app()->theme->baseUrl; ?>/css/style_metfone.css" />
        ...
        <?php
        Yii::app()->clientScript->registerScriptFile(Yii::app()->request->baseUrl."/js/admin/jquery.datetimepicker.js",CClientScript::POS_HEAD);
        ?>
        ...
        <div id="header">
            <div id="header-outer">
                ...
                <div id="header-inner">
                    ...
                    <?php
					$menu = include_once '_menu_cskh.php';
