...
$this->pageLabel = Yii::t("admin","Danh sách Contact");
...
if(Yii::app()->user->hasFlash('Contact')){
    echo '<div class="flash-success">'.Yii::app()->user->getFlash('Contact').'</div>';
}
		...
		*/
		array(
            ...
            'header'=>CHtml::dropDownList('pageSize',$pageSize,array(10=>10,30=>30,50=>50,100=>100),array(
                                                                                  'onchange'=>"$.fn.yiiGridView.update('contact-model-grid',{ data:{pageSize: $(this).val() }})",
                                                                                )),
