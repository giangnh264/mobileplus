...
<div class="song-detail">
    ...
    <div class="player">
        <?php if (!$this->userPhone && false) { ?>
            <a rel="msg_free_content" class=""
               href="<?php echo Yii::app()->createUrl("account/login", array("wrr" => 1, "back" => Yii::app()->request->getRequestUri())) ?>">
        ...
        <?php
            ...
            <?php }else if($isDeactive) {
                $msg = Yii::app()->params['alert_content_limited'];
                $this->widget('application.widgets.touch.common.NotifyMessageWidget', array('msg'=>$msg,'type'=>'song'));
            } else {
    ...
    <div class="action">
        <table width="100%" class="song-action">
            <tr>
                <?php
                    ...
                    <td style="text-align: center;">
                        ...
                        <a rel="msg_free_content" class=""
                           href="<?php echo Yii::app()->createUrl("account/login", array("wrr" => 1, "back" => Yii::app()->request->getRequestUri())) ?>">
                            <?php else: ?>
                            <a href="#download"
                               onclick="downloadContent('<?php echo $song->id ?>', '<?php echo $song->code ?>', 'downloadSong', '')">
                                <?php endif; ?>
                                <p>
                ...
                <!--<td style="text-align: center;" id="song-<?php /*echo $song->id; */?>">
                ...
                <td style="text-align: center;">
                    <a onclick="VegaCoreJs.addSongPlaylist('<?php echo Yii::app()->createUrl('/ajax/getPopupPlaylist', array('phone' => $this->userPhone, 'song_id' => $song['id'])); ?>');"
                       href="#top">
                        <p>
                ...
                <?php if ($song->rbt_codes != ""): ?>
                    <td style="text-align: center;">
                        <a onclick="VegaCoreJs.downloadRbt('<?php echo Yii::app()->createAbsoluteUrl('/ajax/downloadRbt', array('id' => $song['id'])); ?>');"
                           href="#top">
        ...
        <?php if (!empty($lyrics)): ?>
            ...
            <div class="lyrics-full-desc hide text-desc t10 fs_15">
                ...
                <div class="short-desc-view-more">
                    ...
                    <a href="javascript:void(0)"
                       class="lyrics-collapse t10"><?php echo Yii::t('wap', 'Collapse'); ?> &raquo;</a>
                </div>
            </div>
        <?php else: ?>
