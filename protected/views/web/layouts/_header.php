...
$cs->registerCssFile(Yii::app()->request->baseUrl.'/web/css/font-awesome.css?v='.time());
$cs->registerCssFile(Yii::app()->request->baseUrl.'/web/css/font-awesome.min.css?v='.time());
$cs->registerCssFile(Yii::app()->request->baseUrl.'/web/css/css.css?v='.time());
$cs->registerCssFile(Yii::app()->request->baseUrl.'/web/css/css_002.css?v='.time());
...
$cs->registerCssFile(Yii::app()->request->baseUrl.'/web/css/owl.css?v='.time());
$cs->registerCssFile(Yii::app()->request->baseUrl.'/web/css/jquery.mmenu.min.css?v='.time());
$cs->registerCssFile(Yii::app()->request->baseUrl."/web/css/blue.css?v=".time());
$cs->registerCssFile(Yii::app()->request->baseUrl."/web/css/main.css?v=".time());



$cs->registerScriptFile(Yii::app()->request->baseUrl."/web/js/custom.js");
$cs->registerScriptFile(Yii::app()->request->baseUrl."/web/js/jquery.js");
$cs->registerScriptFile(Yii::app()->request->baseUrl."/web/js/jquery_002.js");
$cs->registerScriptFile(Yii::app()->request->baseUrl."/web/js/jquery_003.js");
$cs->registerScriptFile(Yii::app()->request->baseUrl."/web/js/jquery_004.js");
$cs->registerScriptFile(Yii::app()->request->baseUrl."/web/js/jquery-migrate.js");

$cs->registerScriptFile(Yii::app()->request->baseUrl."/web/js/wp-emoji-release.js");
$cs->registerScriptFile(Yii::app()->request->baseUrl."/web/js/wp-embed.js");
$cs->registerScriptFile(Yii::app()->request->baseUrl."/web/js/skip-link-focus-fix.js");
