...
$this->menu=array(
	...
	array('label'=>Yii::t('admin', 'Sao chép'), 'url'=>array('copy','id'=>$model-><?php echo $this->tableSchema->primaryKey; ?>), 'visible'=>UserAccess::checkAccess('<?php echo $this->modelClass;?>Copy')),
);
