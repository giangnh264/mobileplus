<?php if(!empty($this->data)){?>
    <?php
        $obj = array("obj_type"=>$this->albumObject->type,'name'=>$this->albumObject->name,'id'=>$this->albumObject->id,'artist'=>$this->albumObject->artist_name);
        $url = URLHelper::makeUrl($obj);
    ?>
<div class="nhacvnplayer">
<div class="album-player-touch player">
    ...
    <div style="color: rgb(255, 255, 255);" id="control-button">
        ...
        <div class="play control" id="play" style="display: none;">Play</div>
        <div style="" class="pause control" id="pause">Pause</div>
    ...
    <div class="album-player-touch">
        <div class="social-like">
            <ul class="social-box-like" style="margin-top: 10px;">
                <li><?php
                    $this->widget("application.widgets.touch.common.FBLike", array(
                        "url" => $url,
                    ));
                    ?>
                </li>
            ...
            <ul id="playlist" class="list_song album_song_list">
                ...
                if($songs) {
                    ...
                    foreach ($songs as $song) {
                        ...
                        $artistLink = Yii::app()->createUrl("/search") . "?" . http_build_query(array("q" => CHtml::encode($song->artist_name),'type'=>'artist'));
    ...
    <?php }else{
        echo '<div style="margin-left:10px;">Playlist chưa có bài hát nào</div>';
    }?>
</div>
